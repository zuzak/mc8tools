...
<body>
  ...
  <ul>
    <li class="no">You are unable to edit pages.</li>
    <li class="no">You are unable to create pages.</li>
  ...
  <form class="template">
    <label>Intro</label>
    <input class="blurb" type="text" placeholder="a British broadcaster">
    <label>Image</label>
    <input class="img" type="text" placeholder="Brandreth.jpg">
    <label>Caption</label>
    <input class="caption" type="text" placeholder="Brandreth at the RSC, 2007">
  </form>
  <p class="preview">
  </p>
  <form class="projects">
